...
typedef struct {//구조체 선언
	element queue[MAX_QUEUE_SIZE];//max 사이즈를 가진 큐 배열 선언
	int front, rear;
}QueueType;
...
int main(void)
{
	...
	}while(command != 'q' && command != 'Q');//q Q가 아닐때까지 반복
